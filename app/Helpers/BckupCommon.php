...
class Common
{
    public function getPremiumCostMultiplierFEGLI($emp_age = null) // monthly
    {
        ...
        //     $premiumMultiple_C = 0.430;
        // } elseif ($emp_age >= 35 && $emp_age <= 39) {
        //     $premiumMultiple_A = 0.043;
        //     $premiumMultiple_B = 0.043;
        //     $premiumMultiple_C = 0.520;
        // } elseif ($emp_age >= 40 && $emp_age <= 44) {
        //     $premiumMultiple_A = 0.065;
        //     $premiumMultiple_B = 0.065;
        //     $premiumMultiple_C = 0.800;
        // } elseif ($emp_age >= 45 && $emp_age <= 49) {
        //     $premiumMultiple_A = 0.13;
        //     $premiumMultiple_B = 0.130;
        //     $premiumMultiple_C = 1.150;
        // } elseif ($emp_age >= 50 && $emp_age <= 54) {
        //     $premiumMultiple_A = 0.217;
        //     $premiumMultiple_B = 0.217;
        //     $premiumMultiple_C = 1.800;
        // } elseif ($emp_age >= 55 && $emp_age <= 59) {
        //     $premiumMultiple_A = 0.390;
        //     $premiumMultiple_B = 0.390;
        //     $premiumMultiple_C = 2.880;
        // } elseif ($emp_age >= 60 && $emp_age <= 64) {
        //     $premiumMultiple_A = 1.30;
        //     $premiumMultiple_B = 0.867;
        //     $premiumMultiple_C = 5.270;
        // } elseif ($emp_age >= 65 && $emp_age <= 69) {
        //     $premiumMultiple_A = 1.30;
        //     $premiumMultiple_B = 1.040;
        //     $premiumMultiple_C = 6.130;
        // } elseif ($emp_age >= 70 && $emp_age <= 74) {
        //     $premiumMultiple_A = 1.30;
        //     $premiumMultiple_B = 1.863;
        //     $premiumMultiple_C = 8.300;
        // } elseif ($emp_age >= 75 && $emp_age <= 79) {
        //     $premiumMultiple_A = 1.30;
        //     $premiumMultiple_B = 3.900;
        //     $premiumMultiple_C = 12.480;
        // } elseif ($emp_age >= 80) {
        //     $premiumMultiple_A = 1.30;
        //     $premiumMultiple_B = 6.240;
        //     $premiumMultiple_C = 16.900;
        // }
        // $data = [
        //     'premiumMultiple_basic' => 0.3467,
