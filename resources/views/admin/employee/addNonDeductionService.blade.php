                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="info_heading">
                            <p class="text-left">Add Non Deduction Service for which a deposit has NOT been paid</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="basic_info_form_wrap">
                            <form action="{{url('employee/nonDeductionService/save')}}/{{$empId}}" method="POST" id="saveNonDeductionServiceForm">
                                @csrf
                                ...
                                <div class="row in_gap">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <!-- <label for="deposit_owned"><input type="checkbox" name="deposit_owned"> Deposit Owed </label> -->
