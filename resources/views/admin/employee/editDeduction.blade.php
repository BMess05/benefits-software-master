        ...
        <div class="row employee_details_wrap">
            ...
            <div class="col-md-10 employee_detail_block_wrap">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="{{url('employee/deduction/update')}}/{{$deduction['DeductionId']}}" method="POST" id="addDeductionForm">
                            @csrf
                            <div class="col-md-12">
                                <div class="row in_gap">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="deduction_name" value="{{$deduction['DeductionName']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row in_gap">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="amount" value="{{round($deduction['DeductionAmount'], 2)}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
