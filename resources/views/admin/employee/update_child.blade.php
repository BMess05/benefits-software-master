                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="info_heading child_listing_title">
                            <p class="text-left">Update Child</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <form action="{{url('/employee/updateChildData')}}" method="POST" id="addChildForm">
                            @csrf
                            <div class="col-md-12">
                                <div class="row in_gap">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="name" value="{{$childData->ChildName}}">
                                            <input type="hidden" name="ChildId" value="{{$childData->ChildId}}">
                                            <input type="hidden" name="empId" value="{{$childData->EmployeeId}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row in_gap">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="age" value="{{$childData->ChildAge}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
