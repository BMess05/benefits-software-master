                            ...
                            <div class="info_heading child_listing_title">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class=""><a>${{(!empty($data) ? ($data['BasicInc'] == 1) ? $costForBasicPremium : 0 : 0)}}</a></p>
                                                <input type="hidden" name="basic_amount" value="{{ $costForBasicPremium }}">
                                            </div>
                                            <div class="col-md-6">
                                                <p class="text-right"><a>${{(!empty($data) ? ($data['BasicInc'] == 1) ? $costForBasicPremium_old : 0 : 0)}}</a></p>
                                            </div>
                                        </div>
                            ...
                            <div class="info_heading child_listing_title">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class=""><a>${{(!empty($data) ? ($data['OptionAInc'] == 1) ? $costForOptionAPremium : 0 : 0)}}</a></p>
                                            ...
                                            <div class="col-md-6">
                                                <p class="text-right"><a>${{(!empty($data) ? ($data['OptionAInc'] == 1) ? $costForOptionAPremium_old : 0 : 0)}}</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="info_heading child_listing_title">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class=""><a>${{(!empty($data) ? ($data['OptionBInc'] == 1) ? $costForOptionBPremium : 0 : 0)}}</a></p>
                                            ...
                                            <div class="col-md-6">
                                                <p class="text-right"><a>${{(!empty($data) ? ($data['OptionBInc'] == 1) ? $costForOptionBPremium_old : 0 : 0)}}</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="text-right">
                                                    <a>${{(!empty($data) ? ($data['OptionCInc'] == 1) ? $costForOptionCPremium_old : 0 : 0)}}</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="info_heading child_listing_title input_titlelook">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="">${{number_format($abcPlus, 2)}}</p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="text-right">
                                                    ${{ number_format($costForOptionAPremium_old_nf + $costForOptionBPremium_old_nf + $costForOptionCPremium_old_nf, 2) }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="info_heading child_listing_title input_titlelook">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="">${{ number_format(($costForBasicPremium + $costForOptionAPremium + $costForOptionBPremium + $costForOptionCPremium), 2) }}</p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="text-right">
                                                    ${{ number_format($costForBasicPremium_old_nf + $costForOptionAPremium_old_nf + $costForOptionBPremium_old_nf + $costForOptionCPremium_old_nf, 2) }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
